...
#define RGB_BACKLIGHT_DISABLE_AFTER_TIMEOUT 4

// the default brightness
#define RGB_BACKLIGHT_BRIGHTNESS 128

// the default effect (radial2)
#define RGB_BACKLIGHT_EFFECT 10

// the default effect speed (0-3)
#define RGB_BACKLIGHT_EFFECT_SPEED 0

// the default color1 and color2
#define RGB_BACKLIGHT_COLOR_1 { .h = 32, .s = 255 }
#define RGB_BACKLIGHT_COLOR_2 { .h = 128, .s = 255 }
