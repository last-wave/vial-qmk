...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_eighty_m80h(
    ...
    KC_LCTL, KC_NO,   KC_LALT,                   KC_SPC,                                      KC_NO,   KC_RALT, KC_NO,   MO(1),              KC_LEFT, KC_DOWN, KC_RGHT),
  ...
  [_FN1] = LAYOUT_eighty_m80h(
    ...
    KC_TRNS, ALT_F4,  CTL_W,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                     KC_TRNS, KC_TRNS, KC_TRNS,
    ...
    KC_TRNS, KC_TRNS, KC_MPRV,                   KC_MPLY,                                     KC_MNXT, KC_TRNS, KC_TRNS, KC_TRNS,            KC_MPRV, KC_VOLD, KC_MNXT),
